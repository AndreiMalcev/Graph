...
import static java.lang.System.out;
 ...
 class Input{
     static private ArrayList<Integer>[] inputVertex() {
     ...
     static private ArrayList<Integer>[] inputEdges(ArrayList<Integer>[] list) {
         Scanner in = new Scanner(System.in);
     ...
     static UndirectedSparseMultigraph<Integer, Edge> inputGraph() {
         Input input=new Input();
         ArrayList<Integer>[] list = input.inputVertex();
         ArrayList<Integer>[] weight = input.inputEdges(list);
         /*int [] d=Algorithm.dijkstra(list,weight,0);
